...
fn test_creation_range() {
    let t1 = Tensor::new_range(4);
    assert_eq!(t1.shape(), &[4]);
    assert_eq!(t1.data(), &vec![0.0, 1.0, 2.0, 3.0]);

    let t2 = Tensor::new_range(0);
...
fn test_partial_eq_1() {
    let t1 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 2.0, -3.0]).reshaped(&[3, 2]);
    let t2 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 2.0, -3.0]).reshaped(&[3, 2]);
    assert!(t1 == t2);
}
...
fn test_partial_eq_2() {
    let t1 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 2.0, -3.0]).reshaped(&[3, 2]);
    let t2 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 2.0, -3.0]).reshaped(&[2, 3]);
    let p = t1 != t2;
    assert!(p);
}
...
fn test_partial_eq_3() {
    let t1 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 2.0, -3.0]).reshaped(&[3, 2]);
    let t2 = Tensor::new_data(vec![1.0, 2.0, 3.0, 10.0, 3.0, -3.0]).reshaped(&[3, 2]);
    assert!(t1 != t2);
}
