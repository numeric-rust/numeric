    ...
    ($t:ty, $m:ident) => (
        mod $m {
            ...
            fn mv_tensor_rf_tensor_2() {
                ...
                let answer = T::new(vec![2., 2., -6., 9., -2., -2.]).reshape(&[2, 3]);
            ...
            fn rf_tensor_rf_tensor_slices_reverse_1() {
                ...
                let answer = T::new(vec![-1., 4., 0., 12., -4., -8.]).reshape(&[2, 3]);
                assert!(&t1 - &t2 == answer);
            }
            ...
            fn rf_tensor_rf_tensor_slices_reverse_2() {
                ...
                let answer = T::new(vec![-8., 2., 4., 8., -2., -1.]).reshape(&[2, 3]);
                assert!(&t1 - &t2 == answer);
            }
            ...
            fn rf_tensor_rf_tensor_broadcast_1() {
                ...
                let answer = T::new(vec![8., 16., 38., 1., 8., 16.]).reshape(&[3, 2]);
                assert!(&t1 - &t2 == answer);
            }
            ...
            fn rf_tensor_rf_tensor_broadcast_2() {
                ...
                let answer = T::new(vec![8., 18., 36., 1., 9., 19.]).reshape(&[3, 2]);
                assert!(&t1 - &t2 == answer);
            }
            ...
            fn rf_tensor_scalar_1() {
                let t1 = T::new(vec![ 0., 3., 2., 10., -3., 0.]).reshape(&[2, 3]);
                let answer = T::new(vec![-2., 1., 0., 8., -5., -2.]).reshape(&[2, 3]);
                assert!(&t1 - 2. == answer);
            }
